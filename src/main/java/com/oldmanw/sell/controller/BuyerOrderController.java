...
import com.oldmanw.sell.VO.ResultVO;
import com.oldmanw.sell.converter.OrderForm2OrderDTOConverter;
...
import com.oldmanw.sell.utils.ResultVOUtil;
...
public class BuyerOrderController {
    ...
    public ResultVO<Map<String, String>> createOrder(@Valid OrderForm orderForm, BindingResult bindingResult) {
        ...
        if (CollectionUtils.isEmpty(orderDTO.getOrderDetailList())) {
            log.error("【创建订单错误】 购物车不能为空， orderDTO = {}", orderDTO);

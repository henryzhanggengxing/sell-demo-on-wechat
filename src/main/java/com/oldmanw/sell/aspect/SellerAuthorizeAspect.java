package com.oldmanw.sell.aspect;
...
public class SellerAuthorizeAspect {
    ...
    @Pointcut("execution(public * com.oldmanw.sell.controller.Seller*.*(..))" +
    "&& !execution(public * com.oldmanw.sell.controller.SellerUserController.*(..))")
    public void verify() {
